...
export default function SingleDestination() {
  ...
  let destinationId = pathArray[pathArray.length - 1];
  let currentDestination = destinationsData[destinationId];
  let currentAttraction = attractionsData[destinationId];
  return (
    <>
    <div className="singledestination__wrapper">
      ...
      <div className="singledestination__wrapper__text">
        ...
        <h5 className="singledestination__wrapper__text__duration">
          <FaClock className="single__icon"/>Duration: {currentDestination.howLong}days
        </h5>
  ...
  <FaReceipt className="single__icon"/> Availability: {currentDestination.available ? 'Available!' : 'N/A Due to pandemic.'}
        </p>
    ...
    <h3 className="related__attraction__title">Related Attraction:</h3>
        ...
        <div className="related__attraction">
          <img src={currentAttraction.images[0]} className="related__attraction__img" alt={currentAttraction.attraction}/>  
          ...
          <p className="related__attraction__duration">
            <FaClock className="related__attraction__icon"/> Duration: {currentAttraction.howLong}minutes
          </p>
          <p className="related__attraction__price">
            <FaCoins className="related__attraction__icon"/> From: ${currentAttraction.price}
          </p>
          </div>
          <div className="related__attraction__info-2">

          <p className="related__attraction__rating">
            <FaStar className="related__attraction__icon"/> Rating: {currentAttraction.rating}/5.0
          </p>
